...
class Pattern:
    ...
    def generate_pattern(self):
        ...
        Returns:
            None
        """
        # Generate structured input data for more diverse outputs
        input_data = np.linspace(0, 1, self.neural_network.input_size)
        self.canvas = self.neural_network.forward(input_data).reshape(10, 10)
